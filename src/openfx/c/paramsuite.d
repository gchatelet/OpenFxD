...
/** @brief Indicates if the host supports animation of custom parameters 
    ...
    - Value Values - 0 or 1
*/
string kOfxParamHostPropSupportsCustomAnimation="OfxParamHostPropSupportsCustomAnimation";
...
/** @brief Indicates if the host supports animation of string params 
    ...
    - Valid Values - 0 or 1
*/
string kOfxParamHostPropSupportsStringAnimation="OfxParamHostPropSupportsStringAnimation";
...
/** @brief Indicates if the host supports animation of boolean params
    ...
    - Valid Values - 0 or 1
*/
string kOfxParamHostPropSupportsBooleanAnimation="OfxParamHostPropSupportsBooleanAnimation";
...
/** @brief Indicates if the host supports animation of choice params 
    ...
    - Valid Values - 0 or 1
*/
string kOfxParamHostPropSupportsChoiceAnimation="OfxParamHostPropSupportsChoiceAnimation";
...
/** @brief Indicates if the host supports custom interacts for parameters
    ...
    - Valid Values - 0 or 1
*/
string kOfxParamHostPropSupportsCustomInteract="OfxParamHostPropSupportsCustomInteract";
...
*/
string kOfxParamHostPropMaxParameters="OfxParamHostPropMaxParameters";
...
*/
string kOfxParamHostPropMaxPages="OfxParamHostPropMaxPages";
...
*/
string kOfxParamHostPropPageRowColumnCount="OfxParamHostPropPageRowColumnCount";
...
*/
string kOfxParamPageSkipRow="OfxParamPageSkipRow";
...
See \ref ParametersInterfacesPagedLayouts for more details.
*/
string kOfxParamPageSkipColumn="OfxParamPageSkipColumn";
...
*/
string kOfxParamPropInteractV1="OfxParamPropInteractV1";
...
*/
string kOfxParamPropInteractSize="OfxParamPropInteractSize";
...
*/
string kOfxParamPropInteractSizeAspect="OfxParamPropInteractSizeAspect";
...
*/
string kOfxParamPropInteractMinimumSize="OfxParamPropInteractMinimumSize";
...
*/
string kOfxParamPropInteractPreferedSize="OfxParamPropInteractPreferedSize";
...
*/
string kOfxParamPropType="OfxParamPropType";
...
*/
string kOfxParamPropAnimates="OfxParamPropAnimates";
...
/** @brief Flags whether changes to a parameter should be put on the undo/redo stack
    ...
    - Valid Values - 0 or 1
*/
string kOfxParamPropCanUndo="OfxParamPropCanUndo";
 ...
 * If this property is not set, the host will always call
   ...
   modify the property).
*/
string kOfxPropParamSetNeedsSyncing="OfxPropParamSetNeedsSyncing";
...
*/
string kOfxParamPropIsAnimating="OfxParamPropIsAnimating";
...
*/
string kOfxParamPropPluginMayWrite="OfxParamPropPluginMayWrite";
...
*/
string kOfxParamPropPersistant="OfxParamPropPersistant";
...
*/
string kOfxParamPropEvaluateOnChange="OfxParamPropEvaluateOnChange";
...
*/
string kOfxParamPropSecret="OfxParamPropSecret";
...
*/
string kOfxParamPropScriptName="OfxParamPropScriptName";
...
*/
string kOfxParamPropCacheInvalidation="OfxParamPropCacheInvalidation";

 /** @brief Used as a value for the ::kOfxParamPropCacheInvalidation property */
string kOfxParamInvalidateValueChange="OfxParamInvalidateValueChange";

 /** @brief Used as a value for the ::kOfxParamPropCacheInvalidation property */
string kOfxParamInvalidateValueChangeToEnd="OfxParamInvalidateValueChangeToEnd";

 /** @brief Used as a value for the ::kOfxParamPropCacheInvalidation property */
string kOfxParamInvalidateAll="OfxParamInvalidateAll";
...
/** @brief A hint to the user as to how the parameter is to be used.
   ...
   - Default -=""
*/
string kOfxParamPropHint="OfxParamPropHint";
 ...
 */
string kOfxParamPropDefault="OfxParamPropDefault";
...
*/
string kOfxParamPropDoubleType="OfxParamPropDoubleType";
...
string kOfxParamDoubleTypePlain="OfxParamDoubleTypePlain";
...
string kOfxParamDoubleTypeScale="OfxParamDoubleTypeScale";
...
string kOfxParamDoubleTypeAngle="OfxParamDoubleTypeAngle";
...
string kOfxParamDoubleTypeTime="OfxParamDoubleTypeTime";
...
string kOfxParamDoubleTypeAbsoluteTime="OfxParamDoubleTypeAbsoluteTime";
 ...
 */
string kOfxParamDoubleTypenormalizedX ="OfxParamDoubleTypenormalizedX";
 ...
 */
string kOfxParamDoubleTypenormalizedY ="OfxParamDoubleTypenormalizedY";
...
*/
string kOfxParamDoubleTypenormalizedXAbsolute ="OfxParamDoubleTypenormalizedXAbsolute";
 ...
 */
string kOfxParamDoubleTypenormalizedYAbsolute ="OfxParamDoubleTypenormalizedYAbsolute";
...
*/
string kOfxParamDoubleTypenormalizedXY ="OfxParamDoubleTypenormalizedXY";
...
*/
string kOfxParamDoubleTypenormalizedXYAbsolute ="OfxParamDoubleTypenormalizedXYAbsolute";
...
string kOfxParamDoubleTypeX ="OfxParamDoubleTypeX";
...
string kOfxParamDoubleTypeY ="OfxParamDoubleTypeY";
...
string kOfxParamDoubleTypeXAbsolute ="OfxParamDoubleTypeXAbsolute";
...
string kOfxParamDoubleTypeYAbsolute ="OfxParamDoubleTypeYAbsolute";
...
string kOfxParamDoubleTypeXY ="OfxParamDoubleTypeXY";
...
string kOfxParamDoubleTypeXYAbsolute ="OfxParamDoubleTypeXYAbsolute";
...
*/
string kOfxParamPropDefaultCoordinateSystem="OfxParamPropDefaultCoordinateSystem";

/** @brief Define the canonical coordinate system */
string kOfxParamCoordinatesCanonical="OfxParamCoordinatesCanonical";

/** @brief Define the normalized coordinate system */
string kOfxParamCoordinatesnormalized="OfxParamCoordinatesnormalized";
...
*/
string kOfxParamPropHasHostOverlayHandle="OfxParamPropHasHostOverlayHandle";
...
*/
string kOfxParamPropUseHostOverlayHandle="kOfxParamPropUseHostOverlayHandle";
...
*/
string kOfxParamPropShowTimeMarker="OfxParamPropShowTimeMarker";
...
*/
string kOfxPluginPropParamPageOrder="OfxPluginPropParamPageOrder";
...
*/
string kOfxParamPropPageChild="OfxParamPropPageChild";
...
*/
string kOfxParamPropParent="OfxParamPropParent";
...
*/
string kOfxParamPropGroupOpen="OfxParamPropGroupOpen";
...
*/
string kOfxParamPropEnabled="OfxParamPropEnabled";
 ...
 */
string kOfxParamPropDataPtr="OfxParamPropDataPtr";
...
*/
string kOfxParamPropChoiceOption="OfxParamPropChoiceOption";
...
*/
string kOfxParamPropMin="OfxParamPropMin";
...
*/
string kOfxParamPropMax="OfxParamPropMax";
...
*/
string kOfxParamPropDisplayMin="OfxParamPropDisplayMin";
...
*/
string kOfxParamPropDisplayMax="OfxParamPropDisplayMax";
...
*/
string kOfxParamPropIncrement="OfxParamPropIncrement";
...
*/
string kOfxParamPropDigits="OfxParamPropDigits";
...
*/
string kOfxParamPropDimensionLabel="OfxParamPropDimensionLabel";
...
*/
string kOfxParamPropIsAutoKeying="OfxParamPropIsAutoKeying";
 ...
 */
string kOfxParamPropCustomInterpCallbackV1="OfxParamPropCustomCallbackV1";
...
*/
string kOfxParamPropStringMode="OfxParamPropStringMode";
 ...
 */
string kOfxParamPropStringFilePathExists   ="OfxParamPropStringFilePathExists";

/** @brief Used to set a string parameter to be single line, 
    value to be passed to a kOfxParamPropStringMode property */
string kOfxParamStringIsSingleLine   ="OfxParamStringIsSingleLine";

/** @brief Used to set a string parameter to be multiple line, 
    value to be passed to a kOfxParamPropStringMode property */
string kOfxParamStringIsMultiLine    ="OfxParamStringIsMultiLine";

/** @brief Used to set a string parameter to be a file path,
    value to be passed to a kOfxParamPropStringMode property */
string kOfxParamStringIsFilePath     ="OfxParamStringIsFilePath";

/** @brief Used to set a string parameter to be a directory path,
    value to be passed to a kOfxParamPropStringMode property */
string kOfxParamStringIsDirectoryPath="OfxParamStringIsDirectoryPath";

/** @brief Use to set a string parameter to be a simple label, 
    value to be passed to a kOfxParamPropStringMode property  */
string kOfxParamStringIsLabel        ="OfxParamStringIsLabel";
 ...
 */
string kOfxParamPropCustomValue="OfxParamPropCustomValue";
 ...
 */
string kOfxParamPropInterpolationTime="OfxParamPropInterpolationTime";
 ...
 */
string kOfxParamPropInterpolationAmount="OfxParamPropInterpolationAmount";
}
/*@}*/
/*@}*/
...
*/
typedef OfxStatus function(OfxParamSetHandle instance,
					       OfxPropertySetHandle inArgs,
					       OfxPropertySetHandle outArgs) OfxCustomParamInterpFuncV1;


/** @brief The OFX suite used to define and manipulate user visible parameters 
 */
extern(C) struct OfxParameterSuiteV1 {
...
@returns
  ...
  */
  OfxStatus function (OfxParamSetHandle paramSet,
			   const char *paramType,
			   const char *name,
			   OfxPropertySetHandle *propertySet) paramDefine;
...
@returns
  ...
  */
  OfxStatus function(OfxParamSetHandle paramSet,
			      ...
			      OfxPropertySetHandle *propertySet) paramGetHandle;
...
@returns
  ...
  */
  OfxStatus function(OfxParamSetHandle paramSet,
				      OfxPropertySetHandle *propHandle) paramSetGetPropertySet;
...
@returns
  ...
  - ::kOfxStatErrUnknown    - if the type is unknown
  */
  OfxStatus function(OfxParamHandle param,
				   OfxPropertySetHandle *propHandle) paramGetPropertySet;
...
@returns
  ...
  - ::kOfxStatErrBadHandle  - if the parameter handle was invalid
  */
  OfxStatus function(OfxParamHandle  paramHandle,
			     ...) paramGetValue;
...
@returns
  ...
  */
  OfxStatus function(OfxParamHandle  paramHandle,
			       uint  *numberOfKeys) paramGetNumKeys;
...
@returns
  ...
  - ::kOfxStatErrBadHandle  - if the parameter handle was invalid
  */
  OfxStatus function(OfxParamHandle  paramHandle) paramDeleteAllKeys;
  ...
  - ::kOfxStatErrBadHandle  - if the parameter handle was invalid
  */
  OfxStatus function(OfxParamHandle  paramTo, OfxParamHandle  paramFrom, OfxTime dstOffset, OfxRangeD *frameRange) paramCopy;
  ...
  */
  OfxStatus function(OfxParamSetHandle paramSet, const char *name) paramEditBegin; 
...
@returns
  ...
  */
  OfxStatus function(OfxParamSetHandle paramSet) paramEditEnd;
 };