module openfx.c.imageeffectsuite;
...
string kOfxImageEffectActionGetRegionOfDefinition       ="OfxImageEffectActionGetRegionOfDefinition";

/** @brief Action called to get the regions of interest of an effect */
string kOfxImageEffectActionGetRegionsOfInterest        ="OfxImageEffectActionGetRegionsOfInterest";

/** @brief Action called to get the temporal domain of an effect */
string kOfxImageEffectActionGetTimeDomain               ="OfxImageEffectActionGetTimeDomain";

/** @brief Action called to get the frame ranged needed on an input clip to render a single frame */
string kOfxImageEffectActionGetFramesNeeded             ="OfxImageEffectActionGetFramesNeeded";

/** @brief Action called to have a plug-in define input an output clip preferences */
string kOfxImageEffectActionGetClipPreferences      ="OfxImageEffectActionGetClipPreferences";

/** @brief Action called to have a plug-in say if it is an identity transform */
string kOfxImageEffectActionIsIdentity           ="OfxImageEffectActionIsIdentity";

/** @brief Action to render an image */
string kOfxImageEffectActionRender               ="OfxImageEffectActionRender";

/** @brief Action indicating a series of render calls are about to happen */
string kOfxImageEffectActionBeginSequenceRender  ="OfxImageEffectActionBeginSequenceRender";

/** @brief Action to render a series of render calls have completed */
string kOfxImageEffectActionEndSequenceRender     ="OfxImageEffectActionEndSequenceRender";

/** @brief Action to describe an image effect in a specific context */
string kOfxImageEffectActionDescribeInContext    ="OfxImageEffectActionDescribeInContext";
 ...
 */
string kOfxImageEffectPropSupportedContexts="OfxImageEffectPropSupportedContexts";
 ...
 */
string kOfxImageEffectPropPluginHandle="OfxImageEffectPropPluginHandle";
 ...
 */
string kOfxImageEffectHostPropIsBackground="OfxImageEffectHostPropIsBackground";
 ...
 */
string kOfxImageEffectPluginPropSingleInstance="OfxImageEffectPluginPropSingleInstance";
 ...
 */
string kOfxImageEffectPluginPropHostFrameThreading="OfxImageEffectPluginPropHostFrameThreading";
 ...
 */
string kOfxImageEffectPropSupportsMultipleClipDepths="OfxImageEffectPropMultipleClipDepths";
 ...
 */
string kOfxImageEffectPropSupportsMultipleClipPARs="OfxImageEffectPropSupportsMultipleClipPARs";
 ...
 */
string kOfxImageEffectPropClipPreferencesSlaveParam="OfxImageEffectPropClipPreferencesSlaveParam";
 ...
 */
string kOfxImageEffectPropSetableFrameRate="OfxImageEffectPropSetableFrameRate";
 ...
 * See \ref ImageEffectClipPreferences.
 */
string kOfxImageEffectPropSetableFielding="OfxImageEffectPropSetableFielding";
 ...
 */
string kOfxImageEffectInstancePropSequentialRender="OfxImageEffectInstancePropSequentialRender";
 ...
 */
string kOfxImageEffectPropSequentialRenderStatus="OfxImageEffectPropSequentialRenderStatus";
 ...
 */
string kOfxImageEffectPropInteractiveRenderStatus="OfxImageEffectPropInteractiveRenderStatus";
 ...
 */
string kOfxImageEffectPluginPropGrouping="OfxImageEffectPluginPropGrouping";
 ...
 */
string kOfxImageEffectPropSupportsOverlays="OfxImageEffectPropSupportsOverlays";
 ...
 */
string kOfxImageEffectPluginPropOverlayInteractV1="OfxImageEffectPluginPropOverlayInteractV1";
 ...
 */
string kOfxImageEffectPropSupportsMultiResolution="OfxImageEffectPropSupportsMultiResolution";
 ...
 */
string kOfxImageEffectPropSupportsTiles="OfxImageEffectPropSupportsTiles";
 ...
 */
string kOfxImageEffectPropInAnalysis="OfxImageEffectPropInAnalysis";
 ...
 */
string kOfxImageEffectPropTemporalClipAccess="OfxImageEffectPropTemporalClipAccess";
 ...
 *
 */
string kOfxImageEffectPropContext="OfxImageEffectPropContext";
 ...
 */
string kOfxImageEffectPropPixelDepth="OfxImageEffectPropPixelDepth";
 ...
 * Note that for a clip, this is the value set by the clip preferences action, not the raw 'actual' value of the clip.
 */
string kOfxImageEffectPropComponents="OfxImageEffectPropComponents";
 ...
 */
string kOfxImagePropUniqueIdentifier="OfxImagePropUniqueIdentifier";
 ...
 */
string kOfxImageClipPropContinuousSamples="OfxImageClipPropContinuousSamples";
 ...
 */
string kOfxImageClipPropUnmappedPixelDepth="OfxImageClipPropUnmappedPixelDepth";
 ...
 *   - kOfxImageComponentAlpha
 */
string kOfxImageClipPropUnmappedComponents="OfxImageClipPropUnmappedComponents";
 ...
 */
string kOfxImageEffectPropPreMultiplication="OfxImageEffectPropPreMultiplication";

/** Used to flag the alpha of an image as opaque */
string kOfxImageOpaque ="OfxImageOpaque";

/** Used to flag an image as premultiplied */
string kOfxImagePreMultiplied="OfxImageAlphaPremultiplied";

/** Used to flag an image as unpremultiplied */
string kOfxImageUnPreMultiplied="OfxImageAlphaUnPremultiplied";
 ...
 */
string kOfxImageEffectPropSupportedPixelDepths="OfxImageEffectPropSupportedPixelDepths";
 ...
 */
string kOfxImageEffectPropSupportedComponents="OfxImageEffectPropSupportedComponents";
 ...
 *
 */
string kOfxImageClipPropOptional="OfxImageClipPropOptional";
 ...
 */
string kOfxImageClipPropIsMask="OfxImageClipPropIsMask";
 ...
 *
 */
string kOfxImagePropPixelAspectRatio="OfxImagePropPixelAspectRatio";
 ...
 */
string kOfxImageEffectPropFrameRate="OfxImageEffectPropFrameRate";
 ...
 */
string kOfxImageEffectPropUnmappedFrameRate="OfxImageEffectPropUnmappedFrameRate";
 ...
 */
string kOfxImageEffectPropFrameStep="OfxImageEffectPropFrameStep";
 ...
 */
string kOfxImageEffectPropFrameRange="OfxImageEffectPropFrameRange";
 ...
 */
string kOfxImageEffectPropUnmappedFrameRange="OfxImageEffectPropUnmappedFrameRange";
 ...
 */
string kOfxImageClipPropConnected="OfxImageClipPropConnected";
 ...
 */
string kOfxImageEffectFrameVarying="OfxImageEffectFrameVarying";
 ...
 */
string kOfxImageEffectPropRenderScale="OfxImageEffectPropRenderScale";
 ...
 */
string kOfxImageEffectPropProjectExtent="OfxImageEffectPropProjectExtent";
 ...
 */
string kOfxImageEffectPropProjectSize="OfxImageEffectPropProjectSize";
 ...
 * See \ref NormalisedCoordinateSystem for more infomation on the project extent.
 */
string kOfxImageEffectPropProjectOffset="OfxImageEffectPropProjectOffset";
 ...
 *
 */
string kOfxImageEffectPropProjectPixelAspectRatio="OfxImageEffectPropPixelAspectRatio";
 ...
 */
string kOfxImageEffectInstancePropEffectDuration="OfxImageEffectInstancePropEffectDuration";
 ...
 */
string kOfxImageClipPropFieldOrder="OfxImageClipPropFieldOrder";
 ...
 */
string kOfxImagePropData="OfxImagePropData";
 ...
 */
string kOfxImagePropBounds="OfxImagePropBounds";
 ...
 */
string kOfxImagePropRegionOfDefinition="OfxImagePropRegionOfDefinition";
 ...
 */
string kOfxImagePropRowBytes="OfxImagePropRowBytes";
 ...
 *
 */
string kOfxImagePropField="OfxImagePropField";
 ...
 */
string kOfxImageEffectPluginPropFieldRenderTwiceAlways="OfxImageEffectPluginPropFieldRenderTwiceAlways";
 ...
 */
string kOfxImageClipPropFieldExtraction="OfxImageClipPropFieldExtraction";
 ...
 */
string kOfxImageEffectPropFieldToRender="OfxImageEffectPropFieldToRender";
 ...
 */
string kOfxImageEffectPropRegionOfDefinition="OfxImageEffectPropRegionOfDefinition";
 ...
 * This will be in \ref CanonicalCoordinates.
 */
string kOfxImageEffectPropRegionOfInterest="OfxImageEffectPropRegionOfInterest";
...
struct OfxImageEffectSuiteV1
{
	 ...
	 */
	OfxStatus function( OfxImageEffectHandle  imageEffect,
	                               OfxPropertySetHandle* propHandle )getPropertySet;
	 ...
	 */
	OfxStatus function( OfxImageEffectHandle imageEffect,
	                            OfxParamSetHandle*   paramSet ) getParamSet;
	...
	OfxStatus function( OfxImageEffectHandle  imageEffect,
	                           const char*           name,
	                           OfxPropertySetHandle* propertySet ) clipDefine;
	...
	OfxStatus function( OfxImageEffectHandle  imageEffect,
	                              ...
	                              OfxPropertySetHandle* propertySet )clipGetHandle;
	 ...
	 * - ::kOfxStatErrUnknown    - if the type is unknown
	 */
	OfxStatus function( OfxImageClipHandle    clip,
	                                   OfxPropertySetHandle* propHandle )clipGetPropertySet;
	...
	OfxStatus function( OfxImageClipHandle    clip,
	                             OfxTime               time,
	                             OfxRectD*             region,
	                             OfxPropertySetHandle* imageHandle ) clipGetImage;
	 ...
	 */
	OfxStatus function( OfxPropertySetHandle imageHandle )clipReleaseImage;
	...
	OfxStatus function( OfxImageClipHandle clip,
	                                          OfxTime            time,
	                                          OfxRectD*          bounds ) clipGetRegionOfDefinition;
	 ...
	 */
	int function( OfxImageEffectHandle imageEffect ) abort;
	 ...
	 */
	OfxStatus function( OfxImageEffectHandle  instanceHandle,
	                                 size_t                nBytes,
	                                 OfxImageMemoryHandle* memoryHandle ) imageMemoryAlloc;
	 ...
	 */
	OfxStatus function( OfxImageMemoryHandle memoryHandle ) imageMemoryFree;
	 ...
	 */
	OfxStatus function( OfxImageMemoryHandle memoryHandle,
	                                void**               returnedPtr ) imageMemoryLock;
	 ...
	 * - kOfxStatErrBadHandle if the value of \e memoryHandle was not a valid pointer returned by OfxImageEffectSuiteV1::imageMemoryAlloc, null is placed in \e *returnedPtr
	 */
	OfxStatus function( OfxImageMemoryHandle memoryHandle ) imageMemoryUnlock;
...
const OfxStatus kOfxStatErrImageFormat=1000;
